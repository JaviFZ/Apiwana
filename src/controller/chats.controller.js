...
const getChatsData = (id_usuario) => {
    return new Promise(function(resolve, reject) {
        const viaje = "SELECT chats.id_chat, viaje.origen, viaje.destino, viaje.fecha, chats.id_usuario1, chats.id_usuario2, usuarios.nombre, usuarios.foto  FROM railway.chats JOIN viaje ON (chats.id_viaje=viaje.id_viaje) JOIN usuarios ON (chats.id_usuario2=usuarios.id_usuario) WHERE chats.id_usuario1=" + id_usuario
